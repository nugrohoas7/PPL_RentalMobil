...
public class client {
    ...
    private  static  final  String BASE_URL_IMAGE="http://192.168.43.187/rental-api/upload/avatars/";
    private  static  final  String BASE_URL_IMG="http://192.168.43.187/rental-api/upload/";
